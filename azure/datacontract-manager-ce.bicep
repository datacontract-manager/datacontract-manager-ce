...
param webAppName string = 'datacontractmanager-${resourceGroup().name}'
...
param mailFrom string = 'hello@datacontract-manager.com'

@description('The Docker container image URL.')
param containerImageUrl string = 'datacontractmanager/datacontract-manager-ce:latest'
...
param postgresServerName string = 'datacontractmanager-postgres-${resourceGroup().name}'
...
param vnetName string = 'datacontractmanager-vnet'
